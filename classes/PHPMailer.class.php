...
class PHPMailer {
  ...
  public function Send() {
    ...
    switch($this->Mailer) {
      ...
      default:
        $result = $this->MailSend($header, $body);
        break;
        //$this->SetError($this->Mailer . $this->Lang('mailer_nvi_supported'));
        //$result = false;
        //break;
    }
  ...
  public function SmtpSend($header, $body) {
    ...
    if(!$this->smtp->Data($header . $body)) {
      $this->SetError($this->Lang('data_nvi_accepted'));
      $this->smtp->Reset();
      return false;
    }
  ...
  function SetLanguage($lang_type = 'en', $lang_path = 'language/') {
    if( !(@include $lang_path.'phpmailer.lang-'.$lang_type.'.php') ) {
      ...
      $PHPMAILER_LANG["mailer_nvi_supported"] = ' mailer is not supported.';
      $PHPMAILER_LANG["execute"]              = 'Could not execute: ';
      $PHPMAILER_LANG["instantiate"]          = 'Could not instantiate mail function.';
      $PHPMAILER_LANG["authenticate"]         = 'SMTP Error: Could not authenticate.';
      $PHPMAILER_LANG["from_failed"]          = 'The following From address failed: ';
      $PHPMAILER_LANG["recipients_failed"]    = 'SMTP Error: The following ' .
      $PHPMAILER_LANG["data_nvi_accepted"]    = 'SMTP Error: Data not accepted.';
