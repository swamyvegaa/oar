...
$db->update('dealers',"dealer_name='".$dealer_name."',dealer_code='".$dealer_code."',dealer_order='".$dealer_order."',dealer_status='".$dealer_status."',dealer_featured='".$dealer_featured."',dealer_show_in_sitemap='".$dealer_show_in_sitemap."',dealer_store_name='".$dealer_store_name."',dealer_alias='".$dealer_alias."',dealer_title='".$dealer_title."',dealer_address1='".$dealer_address1."',dealer_address2='".$dealer_address2."',dealer_address3='".$dealer_address3."',dealer_city='".$dealer_city."',dealer_state='".$dealer_state."',dealer_country='".$dealer_country."',dealer_zip_code='".$dealer_zip_code."',dealer_phone='".$dealer_phone."',dealer_fax='".$dealer_fax."',dealer_toll_free='".$dealer_toll_free."',dealer_website='".$dealer_website."',dealer_description_top='".$dealer_description_top."',dealer_description_bottom='".$dealer_description_bottom."',dealer_meta_title='".$dealer_meta_title."',dealer_meta_description='".$dealer_meta_description."',dealer_meta_keywords='".$dealer_meta_keywords."',dealer_ad='".$dealer_ad."'$con","id=".$id);
header('Location:dealers.php?start='.$start);
}
