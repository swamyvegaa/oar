...
<?php 
 $productlist = "SELECT id,product_name,product_status,product_featured,product_on_sale,product_code,product_sale_price  FROM  products WHERE product_status!='-1' AND product_dealer=".$_REQUEST['dealer_id']."  LIMIT ".$start.", ".$q_limit.""; 
