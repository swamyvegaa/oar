...
if(isset($_REQUEST['submit']) && $_REQUEST['submit']=='Save'){
  ...
  $denamere = "SELECT dealer_store_name  FROM  dealers WHERE dealer_status!='-1' AND dealer_store_name='".mysql_real_escape_string($_REQUEST['dealer_store_name'])."'"; 
  $denamere_num = sqlnumber($denamere);
  }
 if(@$_REQUEST['dealer_code']!=''){
 $decodere = "SELECT dealer_code  FROM  dealers WHERE dealer_status!='-1' AND dealer_code='".mysql_real_escape_string($_REQUEST['dealer_code'])."'"; 
 $decodere_num = $db->getRow($decodere);
 }
 if(@$_REQUEST['dealer_alias']!=''){
 $dealire = "SELECT dealer_alias  FROM  dealers WHERE dealer_status!='-1' AND dealer_alias='".mysql_real_escape_string($_REQUEST['dealer_alias'])."' AND dealer_alias!=''"; 
...
Dealeradd(mysql_real_escape_string(@$_REQUEST['dealer_name']),mysql_real_escape_string(@$_REQUEST['dealer_code']),@$_REQUEST['dealer_login_email'],mysql_real_escape_string(@$_REQUEST['dealer_pwd']),@$_REQUEST['dealer_order'],@$_REQUEST['dealer_status'],@$_REQUEST['dealer_featured'],@$_REQUEST['dealer_show_in_sitemap'],mysql_real_escape_string(@$_REQUEST['dealer_store_name']),mysql_real_escape_string(@$_REQUEST['dealer_alias']),mysql_real_escape_string(@$_REQUEST['dealer_title']),mysql_real_escape_string(@$_REQUEST['dealer_address1']),mysql_real_escape_string(@$_REQUEST['dealer_address2']),mysql_real_escape_string(@$_REQUEST['dealer_address3']),mysql_real_escape_string(@$_REQUEST['dealer_city']),mysql_real_escape_string(@$_REQUEST['dealer_state']),mysql_real_escape_string(@$_REQUEST['dealer_country']),@$_REQUEST['dealer_zip_code'],@$_REQUEST['dealer_phone'],@$_REQUEST['dealer_fax'],@$_REQUEST['dealer_toll_free'],mysql_real_escape_string(@$_REQUEST['dealer_email']),mysql_real_escape_string(@$_REQUEST['dealer_website']),mysql_real_escape_string(@$_REQUEST['dealer_description_top']),mysql_real_escape_string(@$_REQUEST['dealer_description_bottom']),@$handle->file_dst_name,@$foo->file_dst_name,@$dealer_icon->file_dst_name,mysql_real_escape_string(@$_REQUEST['dealer_meta_title']),mysql_real_escape_string(@$_REQUEST['dealer_meta_description']),mysql_real_escape_string(@$_REQUEST['dealer_meta_keywords']),mysql_real_escape_string(@$_REQUEST['dealer_ad'])); 
