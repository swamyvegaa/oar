...
<div class="content">
<div class="clear"></div>
<div class="dashboard-button clearfix"><a href="pages.php"><img src="cms-images/back-to-pages.png"  /><br/>Manage<br/>Pages</a></div>
...
<td width="50">&nbsp;</td>
<td width="650" align="left"><input type="text"  name="page_name" id="page_name" style="width:400px;" />
  <?php echo @$error['page_name']; ?></td>
</tr>
<tr>
<td width="300" align="left" valign="top">Page Alias [For URL]</td>
<td width="50">&nbsp;</td>
<td width="650" align="left"><input type="text"  name="page_alias" id="page_alias" style="width:400px;" /></td>
</tr>
<tr>
<td width="300" align="left" valign="top">Page Heading [Displayed on Page]</td>
<td width="50">&nbsp;</td>
<td width="650" align="left"><input type="text" name="page_title" id="page_title" style="width:400px;" /></td>
</tr>
<tr>
<td width="300" align="left" valign="top">Priority [For Sorting]</td>
<td width="50">&nbsp;</td>
<td width="650" align="left"><input type="text" name="page_order" id="page_order" width="150" /></td>
</tr>
<tr>
...
<td width="650" align="left"><?php 
                                                                ...
                                                                if (isset($content_det['page_content'])&& !isset($_REQUEST['page_content'])){
																	
                                                                $oFCKeditor->Value = stripslashes(@$content_det['page_content']);
...
<td width="50">&nbsp;</td>
<td width="650" align="left"><input type="file" name="page_banner" id="page_banner" style="width:300px;" /></td>
</tr>
<tr>
<tr>
<td colspan="3">&nbsp;</td>
...
<td width="50">&nbsp;</td>
<td width="650" align="left"><input type="text"  name="page_meta_title" id="page_meta_title" style="width:600px;" /></td>
</tr>
<tr>
<td width="300" align="left" valign="top">Meta Description</td>
<td width="50">&nbsp;</td>
<td width="650" align="left"><textarea   name="page_meta_description" id="page_meta_description" style="width:600px; height:50px;"></textarea></td>
</tr>
<tr>
<td width="300" align="left" valign="top">Meta Keywords</td>
<td width="50">&nbsp;</td>
<td width="650" align="left"><textarea  name="page_meta_keywords" id="page_meta_keywords" style="width:600px; height:50px;"></textarea></td>
</tr>
<tr>
...
<td width="650" align="left"><input type="checkbox" name="page_status" id="page_status"  style="margin-right:20px;" value="1" />Active&nbsp;&nbsp;&nbsp;<input type="checkbox"  name="page_status_sitemap" id="page_status_sitemap" style="margin-right:20px;"  value="1" />Show in Sitemap</td>
</tr>
<tr>
...
<td width="50">&nbsp;</td>
<td width="650" align="left"><textarea  name="page_ad" id="page_ad"  style="width:600px; height:50px;"></textarea></td>
</tr>
<tr>
<td colspan="3">&nbsp;</td>
</tr>
