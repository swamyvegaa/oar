...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        var m=p&&p.scroller_images_width?p.scroller_images_width:"0";
        var n=p&&p.scroller_images_height?p.scroller_images_height:"0";
        var o=p&&p.scroller_title_size?p.scroller_title_size:"12";
        var q=p&&p.scroller_title_color?p.scroller_title_color:"#666";
        ...
        if(h=='enable'){
			...
			dom.find("ul:first").children("li").css("height",n+0+"px");
        }else{
        ...
        function s_s_nav(a,d){
            ...
            a.children("li").css("height","44px");
            a.children("li").css('background-image','url("'+d+'/ad-slider/arrow-lr.png")');
