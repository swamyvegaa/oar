...
'product_secodary_category'    =>  		$product_categoryEle2,								
								...
								header('Location:dealer-products.php?dealer_id='.$_SESSION['dealer_id']);
 }
 
 function Statuschange($id,$newstatus,$start){
 global $db;
$db->update('products',"product_status= '".$newstatus."'","id=".$id);
header('Location:dealer-products.php?dealer_id='.$_SESSION['dealer_id'].'&start='.$start);
