...
?>
<li style=""><a href="dealer-inventory.php?code=<?php echo $value['dealer_code'];?>&name=<?php echo $value['dealer_name'];?>" title=""><img src="<?php echo $value['dealer_thumbnail'];?>" width="225px" height="170px" alt="<?php echo $value['dealer_store_name'];?>" title="<?php echo $value['dealer_store_name'];?>" /></a>
