...
// Common Messages	
		...
		$sucessmessage[13] = "No active subscribers. Mail not sent.";
		...
		$sucessmessage[20] = "Email sent Successfully";
		$sucessmessage[21] = "Password Changed Successfully";
		$sucessmessage[22] = "Either your account is inactived or your email Id is not found in our database";
		$sucessmessage[23] = "Message Submitted Successfully";
		$sucessmessage[24] = "Subscribed Successfully";
		$sucessmessage[25] = "Successfully Submitied";
